      ...
      <ScrollView className="flex-1 px-4 py-6">
        ...
        <View className="relative bg-gray-50 shadow-lg">
          ...
          <View className="absolute flex-row inset-x-0 bottom-5 justify-between px-6">
            <View className="flex-row space-x-2 items-center">
              <Text className="text-[12px] font-bold bg-[#16161657] rounded-md p-1 text-gray-100">
                {data?.price_level}
              </Text>
              <Text className="text-[32px] font-bold bg-[#16161657] rounded-md p-1 text-gray-100">
                {data?.price}
              </Text>
            </View>

            <View className="px-2 py-1 rounded-md justify-center bg-[#67e7cc77]">
        ...
        <View className="mt-6">
          ...
          <View className="flex-row items-center space-x-2 mt-2">
            <FontAwesome name="map-marker" size={30} color="#8C9EA6" />
